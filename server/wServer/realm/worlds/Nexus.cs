...
namespace wServer.realm.worlds
{
    public class Nexus : World
    {
        ...
        public const string NEW_RESOURCE = "wServer.realm.worlds.maps.nexus_new.jm";
        public const string nexusfromlive = "wServer.realm.worlds.maps.nexuslive.jm";
        public const string nexusdragonrealm = "wServer.realm.worlds.maps.nexuslivee.jm";
        ...
        {
			LoadMap(nexusdragonrealm, MapType.Json);
        }
