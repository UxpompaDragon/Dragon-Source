    ...
    partial class BehaviorDb
    {
        private _ Abyss = () => Behav()
            .Init("Archdemon Malphas",
                ...
                new MostDamagers(1,
                    new ItemLoot("Potion of Defense", 12)
                ),
                new Threshold(0.025,
                    new TierLoot(9, ItemType.Weapon, 12),
                    new TierLoot(4, ItemType.Ability, 12),
                    new TierLoot(9, ItemType.Armor, 12),
                    new TierLoot(3, ItemType.Ring, 12),
                    new TierLoot(10, ItemType.Armor, 12),
                    new TierLoot(10, ItemType.Weapon, 12),
                    new TierLoot(4, ItemType.Ring, 12),
                    new ItemLoot("Demon Blade", 12)
                )
            )
            ...
            .Init("Imp of the Abyss",
                ...
                new Threshold(0.5,
                    new ItemLoot("Cloak of the Red Agent", 12),
                    new ItemLoot("Felwasp Toxin", 1)
                    )
            )
            ...
            .Init("Demon Mage of the Abyss",
                ...
                new Threshold(0.1,
                    new ItemLoot("Wand of Dark Magic", 1),
                    new ItemLoot("Avenger Staff", 0.01),
                    new ItemLoot("Robe of the Invoker", 1),
                    new ItemLoot("Essence Tap Skull", 0.01),
                    new ItemLoot("Demonhunter Trap", 1)
                    )
            )
