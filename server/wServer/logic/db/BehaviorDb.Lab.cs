    ...
    partial class BehaviorDb
    {
        ...
        .Init("Dr Terrible",
            new State(
                ...
                new Threshold(0.1,
                    new ItemLoot("Scepter of Fulmination", 1),
                    new ItemLoot("Robe of the Mad Scientist", 1),
                    new ItemLoot("Experimental Ring", 1),
                    new ItemLoot("Wine Cellar Incantation", 1),
                    new ItemLoot("Golden Nut", 1),
                    new ItemLoot("Golden Bolt", 1),
                    new ItemLoot("The Magician Tarot Card", 1),
                    new ItemLoot("Robobuddy Egg", 1),
