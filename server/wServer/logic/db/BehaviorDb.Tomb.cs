            ...
            .Init("Tomb Defender",
                new State(
                    ...
                    new State("artifacts",
                        ...
                        new Reproduce("Pyramid Artifact 1", 999999, 1, 0, 1500),
                        new Spawn("Pyramid Artifact 2", 1, 0),
                        new Reproduce("Pyramid Artifact 2", 999999, 1, 0, 1500),
                        new Spawn("Pyramid Artifact 3", 1, 0),
                        new Reproduce("Pyramid Artifact 3", 999999, 1, 0, 1500),
                    ...
                    new State("artifacts 2",
                        ...
                        new Reproduce("Pyramid Artifact 1", 999999, 3, 0, 1500),
                        new Spawn("Pyramid Artifact 2", 2, 0),
                        new Reproduce("Pyramid Artifact 2", 999999, 3, 0, 1500),
                        new Spawn("Pyramid Artifact 3", 2, 0),
                        new Reproduce("Pyramid Artifact 3", 999999, 3, 0, 1500),
                    ...
                    new Threshold(0.01,
                        new ItemLoot("Ring of the Pyramid", 1),
                        new ItemLoot("Tome of Holy Protection", 1),
                        new ItemLoot("Wine Cellar Incantation", 1),
                        new ItemLoot("Golden Ankh", 1),
                        new ItemLoot("Eye of Osiris", 1),
                        new ItemLoot("Pharaoh's Mask", 1)
                    )
            )
            .Init("Tomb Support",
                new State(
                    ...
                    new State("artifacts",
                        ...
                        new Reproduce("Sphinx Artifact 1", 999999, 1, 0, 1500),
                        new Spawn("Sphinx Artifact 2", 1, 0),
                        new Reproduce("Sphinx Artifact 2", 999999, 1, 0, 1500),
                        new Spawn("Sphinx Artifact 3", 1, 0),
                        new Reproduce("Sphinx Artifact 3", 999999, 1, 0, 1500),
                        new State("blue shield 3",
                            new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                            new TimedTransition(3000, "unset blue shield 3")
                            ),
                    ...
                    new State("double shoot",
                        ...
                        new Reproduce("Sphinx Artifact 1", 999999, 3, 0, 1500),
                        new Spawn("Sphinx Artifact 2", 2, 0),
                        new Reproduce("Sphinx Artifact 2", 999999, 3, 0, 1500),
                        new Spawn("Sphinx Artifact 3", 2, 0),
                        new Reproduce("Sphinx Artifact 3", 999999, 3, 0, 1500),
                        new State("blue shield 4",
                            new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                            new TimedTransition(3000, "unset blue shield 4")
                            ),
                    ...
                    new Threshold(0.01,
                        new ItemLoot("Ring of the Sphinx", 1),
                        new ItemLoot("Wine Cellar Incantation", 1),
                        new ItemLoot("Golden Ankh", 1),
                        new ItemLoot("Eye of Osiris", 1),
                        new ItemLoot("Pharaoh's Mask", 1)
            ...
            .Init("Tomb Attacker",
                new State(
                    ...
                    new State("artifacts",
                        ...
                        new Reproduce("Nile Artifact 1", 999999, 1, 0, 1500),
                        new Spawn("Nile Artifact 2", 1, 0),
                        new Reproduce("Nile Artifact 2", 999999, 1, 0, 1500),
                        new Spawn("Nile Artifact 3", 1, 0),
                        new Reproduce("Nile Artifact 3", 999999, 1, 0, 1500),
                        new State("blue shield 3",
                            new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                            new TimedTransition(3000, "unset blue shield 3")
                            ),
                    ...
                    new State("artifacts 2",
                        ...
                        new Reproduce("Nile Artifact 1", 999999, 3, 0, 1500),
                        new Spawn("Nile Artifact 2", 2, 0),
                        new Reproduce("Nile Artifact 2", 999999, 3, 0, 1500),
                        new Spawn("Nile Artifact 3", 2, 0),
                        new Reproduce("Nile Artifact 3", 999999, 3, 0, 1500),
                        new State("blue shield 4",
                            new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                            new TimedTransition(3000, "unset blue shield 4")
                            ),
                ...
                new Threshold(0.01,
                    new ItemLoot("Ring of the Nile", 1),
                    new ItemLoot("Wine Cellar Incantation", 1),
                    new ItemLoot("Book of Geb", 1),
                    new ItemLoot("Scepter of Geb", 1),
                    new ItemLoot("Shendyt of Geb", 1),
                    new ItemLoot("Geb's Ring of Wisdom", 1)
                )
            )
            //Minions
