    ...
    partial class BehaviorDb
    {
        private _ Deathmage = () => Behav()
            ...
            .Init("Skeleton Veteran",
                ...
                new ItemLoot("Long Sword", 1),
                new ItemLoot("Golden Shield", 1),
                new ItemLoot("Cloak of Darkness", 1),
                new ItemLoot("Spider Venom", 1)
            )
            .Init("Skeleton Mage",
                new State(
                    new Shoot(10),
                ...
                new ItemLoot("Missile Wand", 1),
                new ItemLoot("Comet Staff", 1),
                new ItemLoot("Comet Staff", 1),
                new ItemLoot("Fire Nova Spell", 1)
            )
            .Init("Deathmage",
                new State(
                    new State("Waiting",
