    ...
    partial class BehaviorDb
    {
        ...
        .Init("Limon the Sprite God",
             new State(
                ...
                new Threshold(0.1,
                    new ItemLoot("Staff of Extreme Prejudice", 1),
                    new ItemLoot("Cloak of the Planewalker", 1),
                    new ItemLoot("Wine Cellar Incantation", 1),
                    new ItemLoot("Sprite Wand", 1),
                 ...
                 new Threshold(0.2,
                    new EggLoot(EggRarity.Common, 1),
                    new EggLoot(EggRarity.Uncommon, 1),
                    new EggLoot(EggRarity.Rare, 1),
                    new EggLoot(EggRarity.Legendary, 1)
                     )
            )
            )
