    ...
    partial class BehaviorDb
    {
        ...
        private _ Belladonna = () => Behav()
            ...
            .Init("vlntns Loot Balloon Bella",
                ...
                new Threshold(0.1,
                    new ItemLoot("Diamond Bladed Katana", 1),
                    new ItemLoot("Cupid's Bow", 1),
                    new ItemLoot("Staff of Adoration", 1),
                    new ItemLoot("Wand of Budding Romance", 1),
                    new ItemLoot("Heartfind Dagger", 1),
                    new ItemLoot("Vinesword", 1),
                    new ItemLoot("Bashing Bride Skin", 1),
                    new ItemLoot("Eligible Bachelor Skin", 1)
                )
            );
    }
}
