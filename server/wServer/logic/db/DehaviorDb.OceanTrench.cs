            ...
            .Init("Coral Gift",  //credits to GhostMaree, ???
                new State(
                    ...
                    new State("Texture0",
                        ...
                        new Threshold(0.01,
                            new ItemLoot("Coral Juice", 1),
                            new ItemLoot("Sea Slurp Egg", 1),
                            new ItemLoot("Golden Cockle", 1),
                            new ItemLoot("Golden Conch", 1),
                            new ItemLoot("Golden Horn Conch", 1),
                            new ItemLoot("The Moon Tarot Card", 1),
                            new ItemLoot("Potion of Mana", 1),
                            new ItemLoot("Coral Bow", 1),
                            new ItemLoot("Coral Venom Trap", 1),
                            new ItemLoot("Wine Cellar Incantation", 1),
                            new ItemLoot("Coral Silk Armor", 1),
                            new ItemLoot("Coral Ring", 1)
                            )
                )
